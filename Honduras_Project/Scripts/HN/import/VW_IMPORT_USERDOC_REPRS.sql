--FIELDS userdoc_seq,USERDOC_SERIES,USERDOC_NBR,IND_SERVICE   ,REPRESENTATIVE_TYPE,PERSON_NAME,NATIONALITY_COUNTRY_CODE,RESIDENCE_COUNTRY_CODE,ADDRESS_STREET;;
--QUERY 
select [userdoc_seq]
      ,[userdoc_series]
      ,[userdoc_nbr]
